...
func New(ledger *ledger.Ledger, logger logrus.FieldLogger, bxhID, wasmGasLimit uint64, test bool) Verify {
	ve := validator.NewValidationEngine(ledger, &sync.Map{}, logger, wasmGasLimit, test)
